      ...
      <nav role="navigation" className={styles.nav}>
        ...
        <div className={mainNavClasses}>
          ...
          <ul className={styles.navigation}>
            ...
            <li className={styles.navigationItem}>
              <Link className={navLinkClasses} to="/developers/">Developers</Link>
            </li>
            <li className={styles.navigationItem}>
              <Link className={navLinkClasses} to="/other-stuff/">Other Stuff</Link>
              <span className={styles.expandSub} onClick={((e) => this.showNext(e))}>
                <Down />
              </span>
              <ul className={styles.subNav}>
                <li>
                  <Link className={navLinkClasses} to="/other-stuff/other-stuff-child/">Child</Link>
                </li>
                <li>
                  <Link className={navLinkClasses} to="/other-stuff/other-stuff-child-2/">Child 2</Link>
                </li>
              </ul>
            </li>
          </ul>
