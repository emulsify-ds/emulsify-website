    ...
    <div className="wrapper">
      ...
      <div className={styles.featuresItems}>
        <div className={styles.featuresItem}>
          <h3 className={styles.featuresItemHeading}><Stars className={styles.featuresIcon} />Technology and Design Leaders</h3>
        ...
        <div className={styles.featuresItem}>
          <h3 className={styles.featuresItemHeading}><Wand className={styles.featuresIcon}  />Designers and Marketers</h3>
        ...
        <div className={styles.featuresItem}>
          <h3 className={styles.featuresItemHeading}><Code className={styles.featuresIcon}  />Developers</h3>
