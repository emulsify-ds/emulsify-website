    ...
    <div className={styles.footerWrap + ' wrapper'}>
      <div className={styles.footerParts}>
        ...
        <div className={styles.footerPart2}>
          ...
          <p>Our team creates digital experiences that delight, scale, and deliver measurable results. If you need help creating a design system, the Web Chefs have you covered. <a href="https://fourkitchens.com">Get in touch.</a></p>
        </div>
      </div>
      <p className={styles.tm}>Emulsify is a registered trademark of <a target="_blank" href="http://fourkitchens.com" rel="noopener">Four Kitchens</a></p>
    </div>
  </footer>
)
